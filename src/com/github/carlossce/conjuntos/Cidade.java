package com.github.carlossce.conjuntos;
...
public class Cidade implements Comparable<Cidade> {
    ...
    public String toString() {
        return String.format("%n%nCódigo: %d%nNome: %s%nNúmero Habitantes: %d",
                getCodigoIbge(), getNome(), getTotalHabitantes());
    }
...
//        System.out.printf("Código: %d%nNome: %s%nNúmero Habitantes: %d%n",
//                getCodigoIbge(), getNome(), getTotalHabitantes());
//    }
